...
public class SwingComponent {
    ...
    //创建"新建"菜单项，并为之指定图标
    Icon newIcon = new ImageIcon("ico/new.gif");
    JMenuItem newItem = new JMenuItem("新建",newIcon);
    //创建"保存"菜单项，并为之指定图标
    Icon saveIcon = new ImageIcon("ico/save.gif");
    JMenuItem saveItem = new JMenuItem("保存",saveIcon);
    //创建“退出”菜单项，并为之指定图标
    Icon exitIcon = new ImageIcon("ico/exit.gif");
    JMenuItem exitItem = new JMenuItem("退出",exitIcon);
    JCheckBoxMenuItem autoWrap = new JCheckBoxMenuItem("自动换行");
    //创建复制菜单项，并为之指定图标
    JMenuItem copyItem = new JMenuItem("复制",new ImageIcon("ico/copy.gif"));
    //创建粘贴菜单项，并为之指定图标
    JMenuItem pasteItem = new JMenuItem("粘贴",new ImageIcon("ico/paste.gif"));
    JMenu format = new JMenu("格式");
    JMenuItem commentItem = new JMenuItem("注释");
    JMenuItem cancelItem  = new JMenuItem("取消注释");
    //定义一个右键菜单用于设置程序风格
    JPopupMenu pop = new JPopupMenu();
    //用于组合5个风格菜单项的ButtonGroup
    ...
    public void init(){
        ...
        //使用添加new JMenuItem("-")的方式不能添加菜单分割符
